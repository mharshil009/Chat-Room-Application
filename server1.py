...
def handle_clients(conn,address):
    ...
    msg = name + "Has recently joined the char room"
...
while True:
    ...
    if msg != bytes("#quit", "utf8"):
        ...
        conn.close()
        del clients[conn]
        broadcast(bytes(name +" Left the chat room" , "utf8"))
...
if __name__=="__main__":
    sock.listen(5)
    print("The servre is running and is linstening to clients requests")
